        ...
        <div className='min-h-screen flex flex-col md:flex-row'>
            <div className='right md:w-1/3'>
                ...
                {SignUp &&  <form className='w-9/10 mx-auto bg-grey-700 m-10 min-h-[75vh]' method="post">
                    ...
                    {!sendOtp ? <p className='w-full bg-blue-500 text-white p-2 rounded-lg mt-5 hover:bg-blue-600 text-center' onClick={()=>{setsendOtp(true)}}>Get OTP</p> 

                    : <p type="submit" className='w-full bg-blue-500 text-white p-2 rounded-lg mt-5 hover:bg-blue-600 text-center'>Sign up</p>}
