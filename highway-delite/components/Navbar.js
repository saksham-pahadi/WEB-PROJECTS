...
const Navbar = () => {
    ...
    return (<>
         ...
         <nav className={`navbar ${showNavbar?"fixed -top-50":""}  flex justify-between items-center px-10 py-4`}>
            <Link href="/" className="logo ">
                <svg width="79" height="32" viewBox="0 0 79 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M17.6481 22.5819C17.1264 22.7156 16.5795 22.7866 16.0159 22.7866C15.4121 22.7866 14.8273 22.705 14.2723 22.5523L11.9588 31.1569L15.1159 32L17.6481 22.5819Z" fill="#367AFF" />
                    <path d="M14.1607 22.5205C13.0533 22.1945 12.0683 21.584 11.2909 20.7739L4.92328 27.1199L7.23448 29.4233L14.1607 22.5205Z" fill="#367AFF" />
